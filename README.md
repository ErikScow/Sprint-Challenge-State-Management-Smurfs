...
- [ ] What problem does the context API help solve?
    ...
    It makes it easier to move state elements down to child components without props drilling.

- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

    The store is where state is held, actions are dispatched to the reducer, providing a case for what state to return to the store.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

    Application state are things that all or a very large portion of your app needs. It spans over multiple components, where component state is contained to one component

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

    Redux-thunk is a middleware that allows us to have access to the dispatch function in our action-creators. It makes it possible to have asynchronous actions for something like an api call.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

    I personally prefer Context-API because it is much simpler to use and more in line with how the rest of react works
